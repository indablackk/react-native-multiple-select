...
export default class MultiSelect extends Component {
  static propTypes = {
    ...
    dropdownMenuTextStyle: ViewPropTypes.style,
    dropdownMenuIconStyle: ViewPropTypes.style,
  };
  ...
  _getRow = item => {
    const { selectedItemIconColor, displayKey, styleRowList, styleRowListInner } = this.props;
    return (
      <TouchableOpacity
